...
/* Stands in for a real LMS connection. Hitting Sync LMS calls
   getFakeTasks to pretend we just pulled a fresh task list from
   Canvas or Blackboard. Replace this with a real API call later
   without changing anything else in the app. */
public class LMSMockData {

    /* Returns a hardcoded set of sample tasks covering each subject,
       with a mix of due dates so overdue, due-today, and upcoming
       filters all have something to show during a demo. */
